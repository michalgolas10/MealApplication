...
namespace KuceZBronksuWEB.Areas.Identity.Pages.Account
{
	public class LoginModel : PageModel
	{
		...
		public LoginModel(SignInManager<User> signInManager, ILogger<LoginModel> logger, IPostReportService reportService)
		{
