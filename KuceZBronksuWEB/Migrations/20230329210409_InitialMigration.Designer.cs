...
namespace KuceZBronksuWEB.Migrations
{
    ...
    [Migration("20230329210409_InitialMigration")]
            ...
            modelBuilder.Entity("KuceZBronksuDAL.Images", b =>
                {
                    ...
                    b.Property<string>("LARGEId1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("REGULARId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("REGULARId1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("SMALLId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("SMALLId1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("THUMBNAILId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("THUMBNAILId1")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("KuceZBronksuDAL.Images", b =>
                {
                    ...
                    b.HasOne("KuceZBronksuDAL.LARGE", null)
                        .WithMany()
                        .HasForeignKey("LARGEId1");

                    b.HasOne("KuceZBronksuDAL.REGULAR", "REGULAR")
                        .WithMany()
                        .HasForeignKey("REGULARId");

                    b.HasOne("KuceZBronksuDAL.REGULAR", null)
                        .WithMany()
                        .HasForeignKey("REGULARId1");

                    b.HasOne("KuceZBronksuDAL.SMALL", "SMALL")
                        .WithMany()
                        .HasForeignKey("SMALLId");

                    b.HasOne("KuceZBronksuDAL.SMALL", null)
                        .WithMany()
                        .HasForeignKey("SMALLId1");

                    b.HasOne("KuceZBronksuDAL.THUMBNAIL", "THUMBNAIL")
                        .WithMany()
                        .HasForeignKey("THUMBNAILId");

                    b.HasOne("KuceZBronksuDAL.THUMBNAIL", null)
                        .WithMany()
                        .HasForeignKey("THUMBNAILId1");
